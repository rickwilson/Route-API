...
<html lang="en">
<head>
    <title>Route Open API - Order Types</title>
...
<jsp:include page="/WEB-INF/views/docs/sideMenu.jsp" flush="true" >
    <jsp:param name="page" value="1.5" />
</jsp:include>
<div class="container-fluid myTestContainer">
            <h1>Open API - Order Types</h1>
            <h3>API Endpoint:</h3>
            <div class="row">
                <div class="hidden-xs col-sm-1">&nbsp;</div>
                <div class="col-xs-12 col-sm-11">
                    <strong>URL: </strong> https://api.routeit.cloud/konnektive/v2/get/json/order_types
                    <br>
...
var settings = {
  "async": true,
  "crossDomain": true,
  "url": "http://api.routeit.cloud/open_api/v1/get/json/order_types",
  "method": "GET",
  "headers": {
...
xhr.open("GET", "http://api.routeit.cloud/open_api/v1/get/json/order_types");
...
var options = {
  ...
  "port": null,
  "path": "/open_api/v1/get/json/order_types",
  "headers": {
    "api_key": "YOUR-KEY-HERE",
    "secret": "YOUR-SECRET-HERE",
    "content-type": "application/json",
...
var req = unirest("GET", "http://api.routeit.cloud/open_api/v1/get/json/order_types");
...
Response response = client.newCall(request).execute();
                            ...
                            <h5>Java - Unirest</h5>
                            <pre>
HttpResponse&lt;String&gt; response = Unirest.get("http://api.routeit.cloud/open_api/v1/get/json/order_types")
  ...
  .asString();
                        ...
                        <div id="csharp" class="tab-pane fade">
                            <h5>C# (ReSharp)</h5>
                            <pre>
var client = new RestClient("http://api.routeit.cloud/open_api/v1/get/json/order_types");
...
conn.request("GET", "/open_api/v1/get/json/order_types", headers=headers)
...
url = URI("http://api.routeit.cloud/open_api/v1/get/json/order_types")
...
$request->setUrl('http://api.routeit.cloud/open_api/v1/get/json/order_types');
...
$request->setRequestUrl('http://api.routeit.cloud/open_api/v1/get/json/order_types');
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://api.routeit.cloud/open_api/v1/get/json/order_types",
...
if ($err) {
  ...
  echo $response;
                        ...
                        <div id="other" class="tab-pane fade">
                            <h5>HTTP</h5>
                            <pre>
GET /open_api/v1/get/json/order_types HTTP/1.1
...
wget --quiet \\
  ...
  --header 'cache-control: no-cache' \\
  --output-document \\
  - http://api.routeit.cloud/open_api/v1/get/json/order_types
                            </pre>
                            <h5>Shell - Httpie</h5>
                            <pre>
http GET http://api.routeit.cloud/open_api/v1/get/json/order_types \\
  api_key:YOUR-KEY-HERE \\
  cache-control:no-cache \\
  content-type:application/json \\
  secret:YOUR-SECRET-HERE
...
curl --request GET \\
  ...
  --header 'secret: YOUR-SECRET-HERE'
                            ...
                            <h5>cURL</h5>
                            <pre>
curl -X GET -H "api_key: YOUR-KEY-HERE" -H "secret: YOUR-SECRET-HERE" -H "Content-Type: application/json" -H "Cache-Control: no-cache" -H "http://api.routeit.cloud/open_api/v1/get/json/order_types"
                            </pre>
                            <h5>C (LibCurl)</h5>
                            <pre>
...
curl_easy_setopt(hnd, CURLOPT_URL, "http://api.routeit.cloud/open_api/v1/get/json/order_types");
...
NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"http://api.routeit.cloud/open_api/v1/get/json/order_types"]
...
var request = NSMutableURLRequest(URL: NSURL(string: "http://api.routeit.cloud/open_api/v1/get/json/order_types")!,
...
let uri = Uri.of_string "http://api.routeit.cloud/open_api/v1/get/json/order_types" in
        ...
        "UNKNOWN": "No Order Type Provided"
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>Returns data envelope with valid order types and descriptions if result is SUCCESS or null if result is ERROR.</td>
                        </tr>
                    </table>
                </div>
            </div>
