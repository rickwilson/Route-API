...
import core.thirdParty.aftership.classes.query.ExportTrackingResponse;
import core.thirdParty.aftership.enums.FieldCheckpoint;
...
public class ConnectionAPI {
    ...
    **/
    ...
    public JSONObject request(String method, String url, JSONObject body)
        ...
        connection.setRequestProperty("Accept", "application/openApi");
        connection.setRequestProperty("Content-Type","application/openApi");
