...
@Entity
public class TestOpenApiTracking {
    @Id
    ...
    public TestOpenApiTracking() {
    }

    public TestOpenApiTracking(Tracking tracking, String testApiKey, long accountId, long testOmniTransactionId) {
        this.accountId = accountId;
        this.testApiKey = testApiKey;
        this.testOmniTransactionId = testOmniTransactionId;
        this.testOpenApiQuoteId = tracking.getRoute_quote_id();
        this.testOpenApiOrderId = tracking.getRoute_order_id();
